...
let ``Lightning with eye between the light and surface``() =
    ...
    let result = Object.lighting m light p eyev normalv false (Sphere.create())
...
let ``Lightning with surface in shadow``() =
    ...
    let result = Object.lighting m light p eyev normalv inShadow (Sphere.create())
